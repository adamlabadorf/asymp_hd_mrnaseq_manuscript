...
\textbf{Conclusions}
The caudate nucleus in human HD brain is dramatically affected prior to symptom onset.
Gene expression patterns observed in the symptomatic prefrontal cortex are also present in the caudate, suggesting a common brain-wide response to the disease process.
There are also substantial caudate-specific differences implicating many different biological pathways including metabolism, protein folding, inflammation, and neurogenic processes.
These caudate-specific alterations provide the most detailed insight to date into the most destructive disease process in HD.
